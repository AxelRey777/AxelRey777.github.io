function validar(posicion) {
    ...
    if(cuando.value != "x" && cuadro.value != "o"){
        ...
        switch (posicion) {
            case 1:
                if (cuadro1 == cuadro2 && cuadro1 == cuadro3){
                    console.log("GANADOOOOR ------>"+ cuadro1)
                    pintar(1,2,3);
                ...
                case 2:
                    if (cuadro2 == cuadro1 && cuadro2 == cuadro3){
                        console.log("GANADOOOOR ------>"+ cuadro2)
                        pintar(1,2,3);
                    ...
                    case 3:
                        if (cuadro3 == cuadro2 && cuadro3 == cuadro1){
                            console.log("GANADOOOOR ------>"+ cuadro3)
                            pintar(3,2,1);
                    ...
                    if (cuadro4 == cuadro1 && cuadro4 == cuadro7){
                        console.log("GANADOOOOR ------>"+ cuadro4)
                        pintar(1,4,7);
                    ...
                    case 5:
                        if (cuadro5 == cuadro2 && cuadro5 == cuadro8){
                            console.log("GANADOOOOR ------>"+ cuadro5)
                            pintar(2,5,8);
                        ...
                        if (cuadro6 == cuadro3 && cuadro6 == cuadro9){
                            console.log("GANADOOOOR ------>"+ cuadro6)
                            pintar(3,6,9);
                ...
                if (cuadro7 == cuadro1 && cuadro7 == cuadro4){
                    console.log("GANADOOOOR ------>"+ cuadro7)
                    pintar(1,4,7);
                ...
                case 8:
                    if (cuadro8 == cuadro5 && cuadro8 == cuadro2){
                        console.log("GANADOOOOR ------>"+ cuadro8)
                        pintar(8,5,2);
                    ...
                    case 9:
                        if (cuadro9 == cuadro6 && cuadro9 == cuadro3){
                            console.log("GANADOOOOR ------>"+ cuadro9)
                            pintar(9,6,3);
...
function pintar(p1,p2,p3) {
    document.getElementById("cuadro1"+p1).style.backgroundColor = "blue";
    document.getElementById("cuadro1"+p2).style.backgroundColor = "blue";
    document.getElementById("cuadro1"+p3).style.backgroundColor = "blue";
}